    ...
    <div>
        <div className="static" >
          ...
          <p className='flex justify-start items-center'>
            ...
            Blogs <FaChevronRight className="ml-0 text-green-300 inline-flex items-center" />
            </span>
            <span className=' ml-4 text-black hover:text-green-400 text-2xl'>
            Blogs-Single <FaChevronRight className="ml-0 text-green-300 inline-flex items-center" />
            </span>
          </p>
            <h1 className="mt-6 text-5xl">Blogs Details</h1>
          </div>
          </div>
          </div>
        </div>
